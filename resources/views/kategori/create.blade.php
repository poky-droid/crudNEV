...
<div class="kategori-page">
    ...
    <div class="kategori-header">
        <h2><i class="fa-solid fa-tags"></i>Tambah Kategori</h2>
    </div>
        ...
        <form action="{{ route('kategori.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kategori" id="nama_kategori"
                       ...
                       value="{{ old('nama_kategori') }}" placeholder="Contoh: Backend Development" required>
                @error('nama_kategori')
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                          ...
                          placeholder="Deskripsi singkat mengenai kategori ini (opsional)">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback-custom">{{ $message }}</div>
                @enderror
            </div>
